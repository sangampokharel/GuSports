...
class RulesFragment : Fragment() {
 ...
 override fun onCreate(savedInstanceState: Bundle?) {
    ...
    rules.add(Team("","https://media.istockphoto.com/id/1305966517/vector/playing-badminton-illustration.jpg?s=612x612&w=0&k=20&c=L2yRBybtI3t6cZYtfm_21cWBh9AqlJq2Xj_A5h5kdSo=","Badminton","badminton"))
    ...
    rules.add(Team("","https://carrom.com.ua/wp-content/uploads/2016/01/670px-Play-Carrom-Step-2-668x381.jpg","Carrom","caroom"))
